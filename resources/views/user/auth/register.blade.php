        ...
        <div
            ...
            <form action={{ route('user.register') }} method="POST" id="login" class="w-100">
                ...
                <div class="input-icon-wrapper position-relative">
                    ...
                    <input type="email" name="meta_email" value="{{ old('meta_email') }}" class="d-block w-100 rounded"
                        placeholder="Facebook Email" required />
                </div>
                ...
                <div class="input-icon-wrapper position-relative">
                    ...
                    <input type="email" name="linkedin_email" value="{{ old('linkedin_email') }}"
                        class="d-block w-100 rounded" placeholder="LinkedIn Email" required />
                </div>

                <input type="hidden" name="package" value="1">
                {{-- <div class="input-icon-wrapper">
                    <select type="text" name="package" id="package" class="form-select" required>
