...
@section('styles')
    <style>
        ...
        #postPreview {
            ...
            overflow-y: auto; /* Add scrolling to the preview section if content overflows */
        }
...
<script>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        document.querySelectorAll(".post-description").forEach((postDescription) => {
            const isInstagram = postDescription.closest('#instagram-post');
            if (isInstagram) {
                postDescription.innerHTML = `<span class="username">karuneshtalwar</span> ${defaultDescription.replace(/\n/g, '<br>')}`;
            } else {
            ...
            <div class="col-md-4">
                <div class="w-100 bg-white p-4 rounded-6 overflow-scroll d-flex flex-column gap-3" id="postPreview">
                    ...
                    <div class="card rounded" id="facebook-post">
                        <div class="card-header bg-transparent border-0 d-flex align-items-center justify-content-between pt-2">
                            <div class="d-flex align-items-center">
                                ...
                                <div class="ms-2">
                                    ...
                                    <small class="text-muted">1h · <img src="{{ asset('assets/images/icons/globe.png') }}" width="16" alt=""></small>
                                </div>
                            </div>
                            <div>
                                <img src="{{ asset('assets/images/icons/three-dot-icons.png') }}" width="20px" style="min-width: 20px" alt="">
                            </div>
                        </div>
                        <div class="card-body p-0">
                            <div class="px-4 mb-3 post-description"></div>
                            <div class="post-media">
                                <img src="#" alt="Post Image" class="img-fluid" style="display: none" id="postImage">
                    ...
                    <div class="card rounded mt-4" id="linkedin-post">
                        <div class="card-header bg-transparent border-0 d-flex align-items-center justify-content-between pt-2">
                            ...
                            <div style="width: fit-content">
                                <img src="{{ asset('assets/images/icons/three-dot-icons.png') }}" style="min-width: 20px" width="20px" alt="">
                            </div>
                        </div>
                        <div class="card-body p-0">
                            <div class="px-4 mb-3 post-description"></div>
                            <div class="post-media">
                                <img src="#" alt="Post Image" style="display: none" class="img-fluid" id="postImage">
                                <video controls class="w-100" style="display: none" id="postVideo">
                    ...
                    <div class="card rounded mt-4" id="instagram-post">
                        ...
                        <div class="card-footer d-flex flex-column">
                            <div class="actions">
                                <span><svg aria-label="Like" class="x1lliihq x1n2onr6 xyb1xck" fill="currentColor" height="24" role="img" viewBox="0 0 24 24" width="24">
                                    <title>Like</title>
                                ...
                                <span><svg aria-label="Comment" class="x1lliihq x1n2onr6 x5n08af" fill="currentColor" height="24" role="img" viewBox="0 0 24 24" width="24">
                                    <title>Comment</title>
                                    <path d="M20.656 17.008a9.993 9.993 0 1 0-3.59 3.615L22 22Z" fill="none" stroke="currentColor" stroke-linejoin="round" stroke-width="2"></path>
                                </svg></span>
                                <span><svg aria-label="Share Post" class="x1lliihq x1n2onr6 x5n08af" fill="currentColor" height="24" role="img" viewBox="0 0 24 24" width="24">
